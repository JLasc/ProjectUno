...
var getWeatherState = function(response) {
    ...
    for (i=0; i < response.list.length; i++) { 
        ...
        if (response.list[i].weather[0].id >= 200 && // if id range indicates thunderstorms...
        ...
        else if (response.list[i].weather[0].id >= 300 &&
        ...
        else if (response.list[i].weather[0].id >= 801 &&
...
var doCase = function(weatherState, currentDay) {  // pass in state and day from getWeatherState(); **** WHY DO WE GET "I' FOR FREE? **** (scope conundrum)
    switch(weatherState) {
        case "clear":
            $("#forecast").append(`<div class='weatherToday' id='day${i}'><img id='day${i}' class = 'icons' src='assets/images/32.png'><p>${currentDay}</div>`);
            break;
        ...
        case "rain":
            $("#forecast").append(`<div class='weatherToday' id='day${i}'><img id='day${i}' class = 'icons' src='assets/images/9.png'><p>${currentDay}</div>`);
            break;

        case "thunderstorms":
            $("#forecast").append(`<div class='weatherToday' id='day${i}'><img id='day${i}' class = 'icons' src='assets/images/0.png'><p>${currentDay}</div>`);
            break;
        
        case "error":
            $("#forecast").append(`<div class='weatherToday' id='day${i}'><img id='day${i}' class = 'icons' src='assets/images/44.png'><p>Error!</div>`);
